...
export const SCHEDULE_DAYS: ScheduleDay[] = [
  {
    ...
    events: [
      ...
      },
      {
        ...
        description: "Sheraton Rooftop Bar with RedotsClub. Race standings and team formation begins.",
        color: "byte",
      },
    ],
  },
  {
    ...
    events: [
      ...
      },
      {
        ...
        description: "Define your problem and your first user. Office hours run alongside.",
        color: "azure",
      },
      {
        id: "d2-roast-1",
  ...
  },
  {
    ...
    events: [
      ...
      },
      {
        ...
        description: "Free-and-easy evening. Roam Kuching for dinner. Building continues after.",
        color: "wisp",
      },
      {
        id: "d3-monke-meetup",
  ...
  },
  {
    ...
    events: [
      ...
      },
      {
        ...
        speaker: "Shuen Rui",
        description: "Go-to-market and distribution.",
        color: "wisp",
      },
      {
        id: "d4-content",
      ...
      {
        id: "d4-build",
        title: "Build and deck work",
        start: "12:00",
        end: "12:30",
        description: "Mentorship alongside.",
        color: "azure",
      },
      {
        id: "d4-lunch",
      ...
      {
        id: "d4-cutoff",
        title: "HARD CUTOFF · Race, deck & dinner at Fable",
        start: "18:00",
        end: "21:00",
        description: "Nothing accepted after 18:00. Dinner at Fable. Bus back to Sheraton at 21:00.",
        color: "byte",
        isDeadline: true,
      },
    ],
  },
  {
    ...
    events: [
      ...
      },
      {
        ...
        description: "Judges: SOCOE (Sam), Solana Foundation (Chaerin, Seraphim), Superscrypt (Jacob), + one more.",
        color: "wisp",
      },
      {
        id: "d5-prizes",
